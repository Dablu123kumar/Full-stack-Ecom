            ...
            data.map((product,index) => {
                ...
                >
                  ...
                  <div className=" capitalize px-4 py-2 space-y-0.5 relative">
                    {/* // delete product // */}
                    <div className=" absolute right-0 text-red-600 text-xl rounded-full cursor-pointer hover:bg-red-600 hover:text-white p-1" onClick={()=>deleteProduct(product?._id)}>
                    <MdDelete  /> 
                    </div>
                    ...
                    <div className=" flex items-start gap-3 ">
                        <button className=" flex items-center justify-center border border-red-600 text-red-600 hover:bg-red-600 hover:text-white font-medium rounded-full w-6 h-6" onClick={() => decreaseQuantity(product?._id,product?.quantity)}> - </button>
                        <span className=" font-medium">{product?.quantity} </span>
                        <button className=" flex items-center justify-center border border-red-600 hover:bg-red-600 hover:text-white text-red-600 font-medium rounded-full w-6 h-6" onClick={() => increaseQuantity(product?._id,product?.quantity)}> + </button>
                    </div>
                  </div>
                </div>
                )
