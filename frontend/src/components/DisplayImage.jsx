...
const DisplayImage = ({ imagUrl, onClose }) => {
  return (
    <div className=" fixed top-0 bottom-0 left-0 right-0 z-50 flex justify-center items-center" >
      ...
      <div className='text-2xl hover:text-red-600 cursor-pointer w-fit ml-auto'>
        ...
        <div className=" flex justify-center p-4 max-w-[80vh] max-h-[80vh] overflow-y-scroll scroll-bar">
